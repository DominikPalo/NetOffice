...
[![Build status](https://img.shields.io/github/actions/workflow/status/NetOfficeFw/NetOffice/tests.yml)](https://github.com/NetOfficeFw/NetOffice/actions/workflows/tests.yml)
