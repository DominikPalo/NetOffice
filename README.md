...
[![Tests status](https://img.shields.io/github/actions/workflow/status/NetOfficeFw/NetOffice/tests.yml?label=tests)](https://github.com/NetOfficeFw/NetOffice/actions/workflows/tests.yml)
